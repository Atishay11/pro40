...
function setup() {
  ...
  ground = createSprite(0,550,1500,10);
...
function draw() {
  ...
  textSize(20);
  fill(255);
  text("Score: "+Math.round(score) , 500,40);
...
function spawnCoin() {
  ...
  if (frameCount % 60 === 0) {
    var coin = createSprite(1000,1000,40,10);
    coin.y = Math.round(random(80,600));
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(900,530,10,40);    
